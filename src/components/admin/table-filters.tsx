  ...
  return (
    <form onSubmit={handleSubmit} className="relative flex-1 min-w-[200px]">
      ...
      <input
        ...
        className="w-full rounded-xl border border-border bg-surface py-2.5 pl-9 pr-3 text-sm outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-600/20"
      />
    </form>
  );
}
...
export function SelectFilter({
  ...
  return (
    <select
      ...
      className="rounded-xl border border-border bg-surface px-3 py-2.5 text-sm outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-600/20"
    >
